...
static const char serverIndex[] PROGMEM =
  R"(<html charset="UTF-8"><style type='text/css'>
     ...
     <body>
     <h1>DSMR-injector Flash utility</h1>
     <form method='POST' action='?cmd=0' enctype='multipart/form-data'>
      ...
      <br><hr><br>
      <form action='/' method='GET'><big>Exit Flash utility</big>
          <input type='submit' class='button' name='SUBMIT' value='Exit' ENABLED/>
      </form>
...
static const char successResponse[] PROGMEM = 
  R"(<html>
       ...
       <body>     
         ...
         <br/>Update geslaagd! DSMR-injector zal nu opnieuw opstarten...<br/>
...
void ESP8266HTTPUpdateServer::setup(ESP8266WebServer *server, const String& path, const String& username, const String& password)
{
    ...
    _server->on(path.c_str(), HTTP_POST, [&](){
      ...
      if(upload.status == UPLOAD_FILE_START){
        ...
        if (_serial_output) Serial.print(".");  // printf(".")???
