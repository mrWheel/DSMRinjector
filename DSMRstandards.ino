...
int16_t buildTelegramBE(int16_t line, char telegram[])
{
  ...
  */
  ...
  switch (line)
  {
    //FLU5\253769484_A
    case 0:
      sprintf(telegram, "/FLU5\\253769484_A\r\n");
      break;
    case 1:
      sprintf(telegram, "\r\n");
      break;
    case 2:
      sprintf(telegram, "0-0:96.1.4(50213)\r\n");
      break;
    case 3:
      sprintf(telegram, "0-0:1.0.0(%02d%02d%02d%02d%02d%02dS)\r\n", (year() - 2000), month(), day(), hour(), minute(), thisSecond);
      break;
...
//==================================================================================================
  ...
  switch (line)
  {
    ...
    case 0:
      sprintf(telegram, "/KMP5 KA6U003030303030\r\n");
      break;
    case 1:
      sprintf(telegram, "\r\n");
      break;
    case 2:
      sprintf(telegram, "0-0:96.1.1(4530303336303000000000000000000000)\r\n", val);
      break;
...
void readTelegramFromFile(char *tlgrmFileName)
{
  ...
  while (!telegramEnd)
  {
    ...
    if (telegramStart)
    {
      if (oneLine[0] == '!') telegramEnd   = true;
      snprintf(telegram, sizeof(telegram), "%s\r\n", oneLine);
      len += 2;
      //Debugf("(%2d) %s", len, telegram);  // frustrates processing???
